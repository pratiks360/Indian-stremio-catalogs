...
async function streamRelease(req, res, release, season, episode) {
  ...
  if (!torrent) {
    ...
    // correctly regardless (see _wantedIdx below) — the cost is wasted
    // bandwidth/disk on unwatched episodes and a longer wait before the
    // file reaches the Drive mount catalog.
