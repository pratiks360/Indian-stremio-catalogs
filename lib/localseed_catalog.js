...
async function build() {
  ...
  // stateKey) — a season pack with several mounted episodes resolves to
  // the same imdb_id+type multiple times. Collapse to one card, keeping
  ...
  console.log(`[localseed-catalog] ${deduped.length}/${mounted.length} mounted downloads resolved`);
