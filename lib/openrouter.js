      ...
      try {
        const res = await fetch(CHAT_URL, {
          ...
          body: JSON.stringify({
            ...
            temperature: 0.2,
            max_tokens: 2000,
            // openrouter/free can route to a reasoning-capable model; without
            // this, one has been observed spending the entire token budget on
            // visible chain-of-thought and never emitting the actual answer.
